      ...
      <div className="space-y-6">
        ...
        <div>
          <div className="mb-2 flex items-center justify-between">
            <p className={labelCls}>עוצמת שמע</p>
            <span className="text-sm font-semibold tabular-nums text-gray-700" dir="ltr">
              {audioVolume}%
            </span>
          </div>
          <div className="flex items-center gap-3">
            ...
            />
            {/* Full volume icon */}
            <svg className="h-5 w-5 shrink-0 text-gray-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75}>
              <path strokeLinecap="round" strokeLinejoin="round" d="M19.114 5.636a9 9 0 010 12.728M16.463 8.288a5.25 5.25 0 010 7.424M6.75 8.25l4.72-4.72a.75.75 0 011.28.53v15.88a.75.75 0 01-1.28.53l-4.72-4.72H4.51c-.88 0-1.704-.507-1.938-1.354A9.01 9.01 0 012.25 12c0-.83.112-1.633.322-2.396C2.806 8.756 3.63 8.25 4.51 8.25h2.24z" />
            </svg>
          </div>
        </div>

        {/* ── Play / Pause + Slogan toggles ── */}
        <div>
          <p className={`mb-3 ${labelCls}`}>מצב ניגון</p>
          <div className="flex flex-col gap-3 sm:flex-row">
            ...
            <button
              ...
              className={`
                ...
                text-base font-bold shadow-sm transition-all
            ...
            <button
              ...
              className={`
                ...
                focus:outline-none focus:ring-2 focus:ring-offset-2
                ${playSlogan
                  ? "bg-amber-500 text-white ring-2 ring-amber-300 hover:bg-amber-400 focus:ring-amber-500"
                  : "border-2 border-gray-200 bg-white text-gray-600 hover:border-amber-300 hover:bg-amber-50 hover:text-amber-700 focus:ring-amber-400"
                }
              `}
            >
              {playSlogan ? (
          ...
          {!audioUrl && (
            <p className="mt-2 text-center text-xs text-amber-600">
              ⚠ לא הועלה קובץ אודיו — יש להעלות קובץ לפני ההפעלה
            </p>
          )}
        </div>
